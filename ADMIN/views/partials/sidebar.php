<ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        <div class="sidebar-brand-text mx-3">Milagros Rondan</div>
    </a>
    ...
    <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <h6 class="collapse-header"><i class="fa fa-users"></i></h6>
                <a class="collapse-item" href="index.php?action=cliente">Nuevo Cliente</a>
                <a class="collapse-item" href="utilities-border.html">Consultar Cliente</a>
            </div>
        </div>
    </li>
