...
<html lang="en">
                            ...
                            <li>
                              <div class="media">
                                <div class="media-left">
                                  <a>
                                    <img class="media-object" src="public/img/galeria/1.png" alt="img">
                                  </a>
                                </div>
                          ...
                          <ul class="mu-menu-item-nav">
                            <li>
                              <div class="media">
                                <div class="media-left">
                                  <a>
                                    <img class="media-object" src="public/img/galeria/11.png" alt="img">
                                  </a>
                                </div>
                                <div class="media-body">
                                  <h4 class="media-heading">English Breakfast</h4>
            ...
            <div class="mu-gallery-content">
              ...
              <div class="mu-gallery-body">
                ...
                <div class="mu-single-gallery col-md-4">
                    <div class="mu-single-gallery-item">
	                    <figure class="mu-single-gallery-img">
	                      <a class="mu-imglink" href="public/img/galeria/1.png">
                          <img alt="img" src="public/img/galeria/1.png">
                ...
                <div class="mu-single-gallery col-md-4">
                  	 <div class="mu-single-gallery-item">
                        <figure class="mu-single-gallery-img">
                          <a class="mu-imglink" href="public/img/galeria/2.png">
                            <img alt="img" src="public/img/galeria/2.png">
                             <div class="mu-single-gallery-info">
                                <img class="mu-view-btn" src="assets/img/plus.png" alt="plus icon img">
                            </div> 
                          </a>
                ...
                <div class="mu-single-gallery col-md-4">                  
                  	 <div class="mu-single-gallery-item">
                      <figure class="mu-single-gallery-img">
                        <a class="mu-imglink" href="public/img/galeria/3.png">
                          <img alt="img" src="public/img/galeria/3.png">
                           <div class="mu-single-gallery-info">
                              <img class="mu-view-btn" src="assets/img/plus.png" alt="plus icon img">
                          </div> 
                        </a>
                ...
                <div class="mu-single-gallery col-md-4">                  
                  	<div class="mu-single-gallery-item">
                      <figure class="mu-single-gallery-img">
                        <a class="mu-imglink" href="public/img/galeria/4.png">
                          <img alt="img" src="public/img/galeria/4.png">
                           <div class="mu-single-gallery-info">
                              <img class="mu-view-btn" src="assets/img/plus.png" alt="plus icon img">
                          </div> 
                        </a>
                ...
                <div class="mu-single-gallery col-md-4">                  
                  	<div class="mu-single-gallery-item">
                      <figure class="mu-single-gallery-img">
                        <a class="mu-imglink" href="public/img/galeria/5.png">
                          <img alt="img" src="public/img/galeria/5.png">
                           <div class="mu-single-gallery-info">
                              <img class="mu-view-btn" src="assets/img/plus.png" alt="plus icon img">
                          </div> 
                        </a>
                ...
                <div class="mu-single-gallery col-md-4">                  
                   <div class="mu-single-gallery-item">
                      <figure class="mu-single-gallery-img">
                        <a class="mu-imglink" href="public/img/galeria/6.png">
                          <img alt="img" src="public/img/galeria/6.png">
                           <div class="mu-single-gallery-info">
                              <img class="mu-view-btn" src="assets/img/plus.png" alt="plus icon img">
                          </div> 
                        </a>
                ...
                <div class="mu-single-gallery col-md-4">                  
                  	<div class="mu-single-gallery-item">
                      <figure class="mu-single-gallery-img">
                        <a class="mu-imglink" href="public/img/galeria/7.png">
                          <img alt="img" src="public/img/galeria/7.png">
                           <div class="mu-single-gallery-info">
                              <img class="mu-view-btn" src="assets/img/plus.png" alt="plus icon img">
                          </div> 
                        </a>
                ...
                <div class="mu-single-gallery col-md-4">                  
                  	<div class="mu-single-gallery-item">
                      <figure class="mu-single-gallery-img">
                        <a class="mu-imglink" href="public/img/galeria/8.png">
                          <img alt="img" src="public/img/galeria/8.png">
                           <div class="mu-single-gallery-info">
                              <img class="mu-view-btn" src="assets/img/plus.png" alt="plus icon img">
                          </div> 
                        </a>
                ...
                <div class="mu-single-gallery col-md-4">                  
                  	<div class="mu-single-gallery-item">
                      <figure class="mu-single-gallery-img">
                        <a class="mu-imglink" href="public/img/galeria/10.png">
                          <img alt="img" src="public/img/galeria/10.png">
                           <div class="mu-single-gallery-info">
                              <img class="mu-view-btn" src="assets/img/plus.png" alt="plus icon img">
                          </div> 
                        </a>
                  ...
                  <li>
                    <div class="mu-testimonial-single">                   
                      <div class="mu-testimonial-info">
                        <p>la familia Rondan un grupo de emprendedores rompiendo fronteras y derribando obstaculos</p>
                      </div>
                  ...
                  <div class="mu-contact-left">
                    ...
                    <form id="ajax-contact" method="post" action="mailer.php" class="mu-contact-form">
                      ...
                      <div class="form-group">
                        ...
                        <textarea class="form-control" id="message" name="message"  cols="30" rows="10" placeholder="Mensaje" required></textarea>
                      </div>                      
                  ...
                  <div class="mu-contact-right">
                    <div class="mu-contact-widget">
                      ...
                      <address>
                        ...
                        <p><i class="fa fa-map-marker"></i>Avenida El Sol 678 AV. EL SOL, Av Las Gaviotas, Chorrillos 15056</p>
                      </address>
                    </div>
                    <div class="mu-contact-widget">
  ...
  <!-- Start Map section -->
  <section id="mu-map">
  <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3900.0499429750216!2d-76.99961821581269!3d-12.177003100754767!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x9105b9cd7f000f65%3A0xa1cdc33252dc5dc!2sEl%20Sol%20De%20Milagros%20Rondan!5e0!3m2!1ses!2spe!4v1568423177405!5m2!1ses!2spe" width="100px" height="100px" frameborder="0" style="border:0;" allowfullscreen=""></iframe>
  </section>
  <!-- End Map section -->
      ...
      <div class="row">
        ...
        <div class="mu-footer-area">
           <div class="mu-footer-social">
            <a href="https://www.facebook.com/eventosmilagros.rondan" target="_blank"><span class="fa fa-facebook"></span></a>
